...
public class verifytheMatchCardTest extends BaseClass {
	...
	public  void verifytheMatchcard() throws MalformedURLException, InterruptedException {
		...
		String expectedTourname = excelUtility.getDataFromExcel("MatchCard",1, 2);
		...
		String expectedTeam1Name = excelUtility.getDataFromExcel("MatchCard",2, 2);
		...
		String expectedTeam2Name = excelUtility.getDataFromExcel("MatchCard",3, 2);
		...
		String expectedFlag1Name= excelUtility.getDataFromExcel("MatchCard",4, 2);
		...
		String expectedFlag2Name = excelUtility.getDataFromExcel("MatchCard",5, 2);
		...
		String expectedRemaindermessage = excelUtility.getDataFromExcel("MatchCard",6, 2);
